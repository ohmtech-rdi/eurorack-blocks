...
class ErbuiLexer(RegexLexer):
   ...
   tokens = {
      'root': [
         ...
         (r'module|board|width|material|header|footer|line|control|label|sticker|image|pins|pin|normalling|mode|positioning|position|rotation|offset|layer|silkscreen|translucence|route|faust|address|bind|init|value|property|exclude|extends|alias|file|class|include|pcb|net|type|gpio|pwm|dac', token.Keyword),
