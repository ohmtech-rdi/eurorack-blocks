...
class ErbuiLexer(RegexLexer):
   ...
   tokens = {
      'root': [
         ...
         (r'[0-9\.]+', token.Literal.Number),
         (r'module|board|width|material|header|footer|line|control|label|sticker|image|pin|pins|cascade|mode|positioning|position|rotation|offset|style|route|faust|address|bind|init|value|property|exclude|extends|alias|file', token.Keyword),
