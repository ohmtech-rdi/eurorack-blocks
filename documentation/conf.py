...
class ErbuiLexer(RegexLexer):
   ...
   tokens = {
      'root': [
         ...
         (r'module|board|width|material|header|footer|line|control|label|sticker|image|pins|pin|normalling|mode|positioning|position|rotation|offset|layer|silkscreen|translucence|route|faust|address|bind|init|value|property|exclude|extends|alias|file|class|include|pcb|side|sch|format|net|type|gpio|pwm|dac', token.Keyword),
         (r'face|center|left|top|right|bottom|normalized|bipolar|wire|manual|natural|black|white|aluminum|brushed_aluminum|aluminum_coated|3u|1590bb2_portrait', token.Name.Builtin),
