...
U 1 1 5FF743BE
P 5050 3550
F 0 "R2" H 4900 3500 50  0000 C CNN
F 1 "37.9k" H 4850 3600 50  0000 C CNN
...
F 1 "GND" V 5050 3500 50  0000 C CNN
...
When tension is >0V D1 blocks\nand the schema is a tension divider\n\nWhen tension is <0V D1 shorts\nand the tension on X0 doesn’t go below -0.5V\n\nTension divider is 37.9 / (100 + 37.9) = 0.275\n\n12V * 0.275 = 3.3V\n5V * 0.275 = 1.375V
$Comp
L Device:R R3
U 1 1 613B8734
P 7300 3400
...
Wire Notes Line
	6450 2800 6100 2800
Text Notes 6550 2700 2    50   Italic 0
CHANGE:\nCut the 12V trace\nand bring 3V3
Wire Notes Line
	4900 3300 4900 4050
Wire Notes Line
...
Wire Notes Line
	5350 3300 4900 3300
Text Notes 5450 4300 2    50   Italic 0
CHANGE:\nPut a 37.9k resistor\nin parallel of the diode
Wire Notes Line
	2250 2300 2250 5550
Wire Notes Line
	2250 5550 6650 5550
