...
if __name__ == '__main__':
   try:
      ast_erbb = erbb.parse (os.path.join (PATH_THIS, 'Micropatch.erbb'))
      erbb.generate_gyp (PATH_THIS, ast_erbb)
      erbb.configure ('micropatch', PATH_THIS)
      erbb.cleanup (PATH_THIS)

      ast_erbui = erbui.parse (os.path.join (PATH_THIS, 'Micropatch.erbui'))
