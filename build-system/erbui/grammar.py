...
CONTROL_KINDS = ('AudioIn', 'AudioOut', 'AudioStereoIn', 'AudioStereoOut', 'Button', 'CvIn', 'CvOut', 'Display', 'Encoder', 'EncoderButton', 'GateIn', 'GateOut', 'Led', 'LedBi', 'LedRgb', 'MidiIn', 'MidiOut', 'Pot', 'Switch', 'Trim')
