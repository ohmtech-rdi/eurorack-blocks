...
class KicadPcb:
   ...
   def generate_module_bom (self, path, module):
      ...
      for control in module.controls:
         ...
         elif control.style.is_bourns_pec11r_s:
            inc_part ('bourns.pec11r.s')
      ...
      for part, quantity in parts.items ():
         ...
         elif part == 'bourns.pec11r.s':
            description = 'ROTARY ENCODER MECHANICAL 24PPR'
            dist = 'Digikey'
            dist_pn = 'PEC11R-4220F-S0024-ND'
            dist_link = 'https://www.digikey.de/en/products/detail/bourns-inc/PEC11R-4220F-S0024/4499660'
