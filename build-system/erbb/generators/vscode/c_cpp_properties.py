...
class CCppProperties:
   ...
   def generate_module_includes_firmware (self, path, module):
      ...
      paths.append (os.path.join (PATH_ROOT, 'submodules', 'libDaisy', 'Drivers', 'CMSIS_5', 'CMSIS', 'Core', 'Include'))
      ...
      paths.append (os.path.join (PATH_ROOT, 'submodules', 'libDaisy', 'Middlewares', 'Patched', 'ST', 'STM32_USB_Device_Library', 'Class', 'CDC', 'Inc'))
      paths.append (os.path.join (PATH_ROOT, 'submodules', 'libDaisy', 'Middlewares', 'ST', 'STM32_USB_Host_Library', 'Core', 'Inc'))
      paths.append (os.path.join (PATH_ROOT, 'submodules', 'libDaisy', 'Middlewares', 'ST', 'STM32_USB_Host_Library', 'Class', 'MSC', 'Inc'))
      paths.append (os.path.join (PATH_ROOT, 'submodules', 'libDaisy', 'Middlewares', 'ST', 'STM32_USB_Host_Library', 'Class', 'MIDI', 'Inc'))
