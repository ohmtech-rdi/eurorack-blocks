...
CONTROL_KINDS = ('AudioInDaisy', 'AudioOutDaisy', 'Button', 'CvIn', 'GateIn', 'GateOut', 'Led', 'LedBi', 'Pot', 'Switch', 'Trim')
CONTROL_STYLES = (
...
def angle_declaration ():              return [float_deg_ccw_literal, float_deg_cw_literal]
