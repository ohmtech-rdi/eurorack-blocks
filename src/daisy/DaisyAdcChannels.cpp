...
DaisyAdcChannels::DaisyAdcChannels (daisy::DaisySeed & seed)
:  _seed (seed)
{
}
...
void  DaisyAdcChannels::add (DaisyAnalogControlBase & control, const Pin & pin)
{
...
void  DaisyAdcChannels::add (DaisyMultiplexer & multiplexer, const Pin & pin, const DaisyMultiplexerAddressPins & address_pins)
{
   auto & channel = _channels [_nbr_adc_channel];
   ++_nbr_adc_channel;
